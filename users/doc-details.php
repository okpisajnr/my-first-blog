...
<html lang="en">
  <head>
    ...
    <title>OSPMS | Chapters Details</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Chapter Details</h3>
            <hr />
...
{?>
-->         <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Chapter Number : </b></label>
          		<div class="col-sm-4">
          		<p><!-- <php echo htmlentities($row['complaintNumber']);?> --></p>
          		</div>
<label class="col-sm-2 col-sm-2 control-label"><b>Sent Date :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Topic :</b></label>
              <div class="col-sm-4">
              <p><!-- <php echo htmlentities($row['noc']);?> --></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>File :</b></label>
              <div class="col-sm-4">
              <p><!--<php $cfile=$row['docFile'];
if($cfile=="" || $cfile=="NULL")
{
  echo htmlentities("File NA");
}
else{ ?>
<a href="feedbackdocs/<php echo htmlentities($row['docFile']);?>" target='_blank'>  -->View File</a>
<!--<php } ?>-->
...
<label class="col-sm-2 col-sm-2 control-label"><b>Remark:</b></label>
              <div class="col-sm-10">
   <!-- <php echo  htmlentities($rw['remark']); ?> -->&nbsp;&nbsp; </b>
              </div>
            </div> 
 <div class="row mt">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Proceed :</b></label>
              <div class="col-sm-4">
...
<php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Message </label>
              <div class="col-sm-10">
