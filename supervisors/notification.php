...
$sql=mysqli_query($con, "INSERT INTO tblfeedback (id, Sender, reciever, topic, Nfile, msg, Ntime) VALUES (NULL,'$sender','$student','$topic','$file','$content', CURRENT_TIME)
");
...
<?php include("includes/sidebar.php");?>
      <section id="main-content">
          <section class="wrapper">
            ...
            <h3><i class="fa fa-angle-right"></i> Send Feedback </h3>
...
<select name="std" class="form-control"  required>
  <?php $ret=mysqli_query($con,"select * from students where SupervisorMail = '".$_SESSION['login']."'");
  $cnt = 1;
...
<button type="submit" name="submit" class="btn btn-primary form-control">Post</button>
</div>
</div>
