...
<?php include('includes/sidebar.php');?>
      <section id="main-content">
          ...
          <h3><i class="fa fa-angle-right"></i> Student Chapter Details</h3>
            <hr />
...
<?php } ?>
            ...
            <label class="col-sm-2 col-sm-2 control-label"><b></b></label>
              <div class="col-sm-4">
            <a class="btn btn-info" href="updateProject.php?cid=<?php echo htmlentities($row['ProjectNumber']);?>" onClick="return confirm('Are you sure you want to details?')">Take Action
</a>
              </div>
