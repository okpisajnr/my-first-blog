...
{
$sql=mysqli_query($con,"SELECT Password FROM  tblsupervisor where Password='".md5($_POST['password'])."' && username='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update tblsupervisor set Password='".md5($_POST['newpassword'])."' where username='".$_SESSION['login']."'");
