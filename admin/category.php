...
$sql=mysqli_query($con,"INSERT INTO category (id, categoryName, categoryDescription, creationDate) VALUES (NULL,'$category','$Description', CURRENT_TIME)");
...
<div class="controls">
<textarea name="Description" cols="9" rows="5" class="span8 tip" ></textarea></div>
</div>
