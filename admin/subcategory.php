...
$sql=mysqli_query($con,"INSERT INTO subfield (id, categoryId, area, Cdate) VALUES (NULL,'$category','$subcat', CURRENT_TIME)");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from subfield where id = '".$_GET['id']."'");
...
<div class="control-group">
<label class="control-label" for="basicinput">Subfield Name</label>
<div class="controls">
...
<?php $query=mysqli_query($con,"select subfield.id,category.categoryName,subfield.area,subfield.Cdate from subfield join category on category.id=subfield.categoryId");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>									
